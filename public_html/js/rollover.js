...
//
// Version 1.0b. Bug fix--for older browsers
// Version 1.0a. Bug fix--pointing type rollovers weren't loading
//               blank image. --wew
// Version 1.0.  First release with Creative HTML Design --wew
//
...
//     link. 
//
//     The "imagenames" array uses two images: first is the "pointing"
//     image, second is the "blank" state image. 
// 
...
if (rtype == "pointing") {
  ...
  if (imagenames[1]) { blank.src  = path + imagenames[1] + ext; }
  }
if (rtype == "slideshow") {
  blank = new Image();
  for (var i = 0; i < imagenames.length; i++) {
